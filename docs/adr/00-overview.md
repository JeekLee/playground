...
```
   ...
   Data stores (compose-internal):
     playground-postgres:5432  (Postgres 16 + pgvector, schema-per-BC, ADR-05)
     playground-redis:6379     (Spring Session + rag-ingestion locks, ADR-07, ADR-08 amendment)
     playground-opensearch:9200 (search projection from M2+, ADR-05 amendment)
