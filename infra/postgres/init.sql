...
-- (backend/rag-chat/rag-chat-infra/src/main/resources/db/migration/), not
-- here. Per ADR-14 §3 + §3.1, the rag-chat-api Hikari connection sets
...
-- Cross-schema writes remain forbidden — rag-chat writes only to `chat`.
