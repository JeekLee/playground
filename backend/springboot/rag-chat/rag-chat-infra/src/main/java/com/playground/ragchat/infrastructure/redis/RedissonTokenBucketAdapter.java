 ...
 *
 * <p>Bucket keys ({@code rag-chat:bucket:user:&lt;userId&gt;:hourly|daily}) self-
...
public class RedissonTokenBucketAdapter implements TokenBucketPort {
    ...
    private static final String HOURLY_KEY_FMT = "rag-chat:bucket:user:%s:hourly";
    private static final String DAILY_KEY_FMT = "rag-chat:bucket:user:%s:daily";
