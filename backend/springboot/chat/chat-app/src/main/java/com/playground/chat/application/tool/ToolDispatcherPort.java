...
/**
 * Outbound port from {@code chat-app} to the tool-BC dispatch
 * adapter per ADR-17 §8. Implementation lives in {@code chat-infra}
 ...
 * {@code chat-infra}; this port is the application-layer surface
