 ...
 * WireMock integration test in {@code chat-infra} which can wire a
...
class ChatTurnServiceToolCallingTest {
    ...
    void toolBindingsListShape_matchesCatalogPlumbing_whenCalled() {
        ...
        // integration test in chat-infra.
    ...
    void multiTurn_emitsToolCallThenToolResult_andInterleavesTokens() {
        ...
        // real use-case (the integration test in chat-infra covers the
        ...
        when(toolDispatcherPort.invoke(any(), eq("echo"), any(), any(), any()))
                .thenAnswer(inv -> {
                    ...
                    return new com.playground.chat.application.tool.ToolInvocationResult.Success(
