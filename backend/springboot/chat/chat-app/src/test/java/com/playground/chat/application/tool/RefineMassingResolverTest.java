...
/**
 * Unit test for {@link RefineMassingResolver#resolve} — the M9 resolve / validate
 ...
 * rather than dispatched. (Extracted from ToolLoopRefineArgsTest in #250.)
 */
class RefineMassingResolverTest {
    ...
    void setUp() {
        ...
        userCtx = new UserContext(caller, "sub-1");
    }

    private JsonNode resolve(String toolName, JsonNode args, String callId) {
        return RefineMassingResolver.resolve(toolName, args, callId, userCtx, attachmentRepository, sink);
    }
    ...
    void modelAttachment_resolvesBaseStorageKey_andStripsBaseAttachmentId() {
        ...
        JsonNode out = resolve("refine_massing", args, "call_1");
    ...
    void nonModelAttachment_emitsToolError_andReturnsNull_soDispatchIsSkipped() {
        ...
        JsonNode out = resolve("refine_massing", args, "call_2");
    ...
    void notFoundId_emitsToolError_andReturnsNull() {
        ...
        JsonNode out = resolve("refine_massing", args, "call_3");
    ...
    void nonUuidId_emitsToolError_andReturnsNull_withoutRepoLookup() {
        ...
        JsonNode out = resolve("refine_massing", args, "call_4");
    ...
    void nonRefineTool_passesArgsThroughUntouched() {
        ...
        JsonNode out = resolve("search_documents", args, "call_5");
