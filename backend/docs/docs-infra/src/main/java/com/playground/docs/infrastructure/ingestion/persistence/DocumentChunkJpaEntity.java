...
/**
 * JPA mirror of {@link com.playground.docs.ingestion.domain.model.DocumentChunk}
 ...
 * writes to {@code docs.document_chunks} go through {@code JdbcTemplate}
 ...
 * (`SELECT document_id, body_checksum FROM docs.document_chunks ...`) gets a
 * typed binding for free.
 */
@Entity
@Table(name = "document_chunks", schema = "docs")
